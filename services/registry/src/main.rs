...
pub async fn init() -> Result<rocket::Rocket<rocket::Build>> {
    ...
    let rocket = rocket::build()
        .mount("/", routes![
            ...
            api::chat::bsky::delete_message_for_self,
            api::chat::bsky::delete_account,
            api::chat::bsky::export_account_data,
            api::chat::bsky::get_convo,
            api::chat::bsky::get_convo_for_members,
            api::chat::bsky::get_log,
            api::chat::bsky::get_messages,
            api::chat::bsky::leave_convo,
            api::chat::bsky::list_convos,
            api::chat::bsky::mute_convo,
            api::chat::bsky::send_message,
            api::chat::bsky::send_message_batch,
            api::chat::bsky::unmute_convo,
            api::chat::bsky::update_read,
            robots,
            health,
            bsky_api_forwarder,
            all_options

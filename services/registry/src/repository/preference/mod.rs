...
use crate::database::models::AccountPref;
use crate::repository::preference::util::pref_in_scope;
...
impl PreferenceReader {
    ...
    pub async fn get_preferences(
        ...
        use crate::schema::registry::account_pref::dsl as AccountPrefSchema;

...
impl MST {
    ...
    pub fn from_data(storage: RepoReader, data: NodeData, layer: Option<u32>) -> Result<MST> {
    ...
    pub fn load(storage: RepoReader, cid: Cid, layer: Option<u32>) -> Result<MST> {

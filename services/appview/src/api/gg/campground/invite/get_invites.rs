use appview_schema::{
    models::appview::{Actor, CampsiteInvite, Profile},
    schema::appview::{campsite_invite, profile},
};
use campground_lexicon::gg::campground::invite::{
    CampsiteInviteViewCampsite, GetCampsiteInvitesOutput,
};
...
#[get("/xrpc/gg.campground.invite.getInvites?<campsite_id>&<limit>&<offset>")]
pub async fn get_invites(
    auth: CampsiteInfo<'_>,
    campsite_id: &str,
    limit: Option<i64>,
    offset: Option<i64>,
) -> Result<Json<GetCampsiteInvitesOutput>> {

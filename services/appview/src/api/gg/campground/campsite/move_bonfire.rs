...
#[post("/xrpc/gg.campground.campsite.moveBonfire?<bonfire_id>", data = "<body>")]
pub async fn move_bonfire(auth: BonfireInfo<'_>, event_subject: &State<ReactiveSubject>, bonfire_id: &str, body: Json<MoveBonfireBody>) -> Result<Json<BonfireViewBasic>> {    
    ...
    event_next_bonfire(event_subject, &bonfire, false, "BonfireMoved", bonfire_view_basic(bonfire));
